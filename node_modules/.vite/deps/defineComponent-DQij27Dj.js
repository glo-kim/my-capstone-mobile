...
function extractNumber(text, decimalDigitsLimit, decimalSeparator) {
	...
	const cleanText = normalizeMinusSign(text).split("").filter((x) => onlyValidCharacters.test(x)).filter((x, i, all) => i === 0 && /[-]/.test(x) || x === decimalSeparator && i === all.indexOf(x) || /\d/.test(x)).join("");
...
//#endregion
export { normalizeMinusSign as $, findChildrenWithProvide as A, hasEvent as B, defer as C, eventName as D, escapeForRegex as E, getEventCoordinates as F, isObject as G, includes as H, getNextElement as I, keyValues as J, isOn as K, getObjectValueByPath as L, focusChild as M, focusableChildren as N, extractNumber as O, getDecimals as P, noop as Q, getPropertyFromItem as R, deepToRaw as S, ensureValidVNode as T, isComposingIgnoreKey as U, humanReadableFileSize as V, isEmpty as W, matchesSelector as X, keys as Y, mergeDeep as Z, chunkArray as _, SUPPORTS_TOUCH as _t, createDefaults as a, pickWithRest as at, createRange as b, deprecate as bt, getCurrentInstance as c, templateRef as ct, CircularBuffer as d, IN_BROWSER as dt, omit as et, EventProp as f, IS_WEBKIT as ft, chunk as g, SUPPORTS_MATCH_MEDIA as gt, checkPrintable as h, SUPPORTS_INTERSECTION as ht, DefaultsSymbol as i, pick as it, flattenFragments as j, filterInputAttrs as k, getCurrentInstanceName as l, toKebabCase as lt, camelizeProps as m, SUPPORTS_EYE_DROPPER as mt, defineFunctionalComponent as n, padEnd as nt, provideDefaults as o, refElement as ot, callEvent as p, PREFERS_REDUCED_MOTION as pt, isPrimitive as q, genericComponent as r, padStart as rt, useDefaults as s, renderSlot as st, defineComponent as t, onlyDefinedProps as tt, propsFactory as u, wrapInArray as ut, clamp as v, consoleError as vt, destructComputed as w, debounce as x, convertToUnit as y, consoleWarn as yt, has as z };
